...
const BottomNavConstant = ({propertyDetail}) => {
  return (
    ...
    <div>
        <h3 className='font-[NeueMedium] lg:text-left text-center text-[1.2rem]  text-[#272727] capitalize lg:text-[2rem]'>Chapter 1</h3>
        <h3 className='font-[NeueRegular] lg:text-left text-center lg:text-[1rem]  text-[.7rem] ' >Starting At: Rs.28,000</h3>
    </div>
        <div className='flex items-center gap-2 lg:gap-12 justify-center' >
            
            {/* <a href="https://youtu.be/YukkDVVWgm0?si=OG8L4_vGW86mRxco"> <button className="uppercase w-[155px] lg:w-[280px]  flex items-center justify-center lg:gap-3 gap-2 rounded-lg shadow-md  font-[NeueMedium] ease-in duration-300  text-[10px] md:text-[16px]  hover:shadow-none hover:bg-[#272727] tracking-wider py-[8px] px-[6px] mt-3 md:py-[12px] md:px-[24px] text-[#FFFEFC] bg-[#D64C27]" > <AiOutlineYoutube className="text-[1rem] lg:text-[1.5rem]" />Property Tour</button></a>
